...
class OptionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Option::create([
            ...
            'type' => 'string',
            'value' => 'https://facebook.com/yukdonasi.org',
        ]);

        Option::create([
            'key' => 'official_twitter',
            'type' => 'string',
            'value' => 'https://twitter.com/yukdonasi.org',
        ]);

        Option::create([
            'key' => 'official_instagram',
            'type' => 'string',
            'value' => 'https://instagram.com/yukdonasi.org',
        ]);

        Option::create([
            'key' => 'official_gplus',
            'type' => 'string',
            'value' => 'https://plus.google.com/yukdonasi.org',
        ]);
        ...
        Option::create([
            ...
            'value' => [
                ...
                'link' => 'http://yukdonasi.org.org',
                'image' => 'http://yukdonasi.org.org/images/iklan2.jpeg',
            ],
        ]);
