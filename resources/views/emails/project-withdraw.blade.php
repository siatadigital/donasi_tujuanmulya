...
<body class="no-padding" style="margin: 0;-webkit-text-size-adjust: 100%;background-color: #fff;">
  ...
  <div class="wrapper" style="background-color: #fff;">
    ...
    <table class="layout layout--no-gutter layout--full-width"
      style="border-collapse: collapse;table-layout: fixed;Margin-left: auto;Margin-right: auto;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;width: 100%;background-color: #ffffff;"
      align="center">
      <tbody>
        <tr>
          <td class="layout__edges">&nbsp;</td>
          <td class="column"
            style="font-size: 14px;line-height: 21px;padding: 0;text-align: left;vertical-align: top;color: #a6b0b3;font-family: Roboto,Tahoma,sans-serif;"
            width="600">

            <div style="Margin-left: 20px;Margin-right: 20px;">
              <div class="divider"
                style="display: block;font-size: 2px;line-height: 2px;width: 40px;background-color: #ccc;Margin-left: 260px;Margin-right: 260px;Margin-bottom: 20px;">
                &nbsp;</div>
            </div>
            ...
            <?php
                ...
                $replace = [
                    $project->user->name,
                    $project->title,
                    priceFormat($withdraw->amount),
                    strtoupper($withdraw->account_bank) . ' - ' . $withdraw->account_number . ' a/n ' . $withdraw->account_name,
        ...
        <tr>
          <td style="padding: 0 0 40px 0;">
            ...
            {{-- <table class="footer__left"
              style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;color: #5c6266;font-family: Roboto,Tahoma,sans-serif;"
              width="400">
              <tbody>
                <tr>
