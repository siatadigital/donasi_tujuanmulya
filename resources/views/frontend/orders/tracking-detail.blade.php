...
<div class="container">
  <div class="tracking-order-head">
    ...
    <p>
      Menampilkan status pesanan dengan kode <b>{{ $order->code }}</b>
    </p>
  </div>
            ...
            <table class="table">
              ...
              <tbody>
                  ...
                  <td>
                    ...
                    <div class="tanggal">
                      ...
                      @if ($order->payment)
                        ...
                        <a href="{{ route('frontend.order.payment_confirm', ['id' => $order->id]) }}"
                          class="btn pembayaran-btn">Saya sudah membayar</a>
                        @endif
                      @endif
                    </div>
                    @endif
                ...
                <tr class="" data-href='#'>
                  ...
                  <td>
                    <div class="history-detail-sub-title">Total Pembayaran</div>
                    <h2 class="nominal" style="margin-bottom: 16px;">Rp.
                      {{ number_format($amountTransfer, 0, ',', '.') }}</h2>
                    <div class="history-detail-sub-title">Total Berat</div>
                    <div class="history-detail-berat">
                      <img src="{{ url('img/kilogram.png') }}">
                      <span>{{ number_format($order->total_weight, 0, ',', '.') }} gram</span>
              ...
              <div class="checkout-info-pembeli">
                ...
                <div class="info-box">
                  ...
                  <div class="main">
                    ...
                    <p style="margin-bottom: 0px">{{ $order->delivery->originSubdistrict->province->name }},
                      {{ $order->delivery->originSubdistrict->city->name }},
                      {{ $order->delivery->originSubdistrict->name }}</p>
              ...
              <div class="checkout-info-pembeli">
                ...
                <div class="info-box">
                  ...
                  <div class="main">
                    ...
                    <p style="margin-bottom: 0px">{{ $order->delivery->destinationSubdistrict->province->name }},
          ...
          <div class="cart-table">
            ...
            <div class="cart-row">
              ...
              <div class="col-berat cart-col">
                ...
                <div class="berat-box">{{ number_format($item->weight * $item->colors->sum('quantity'), 0, ',', '.') }} gram</div>
              </div>
          ...
          <div class="cart-foot">
            ...
            <div class="info-totals">
              ...
              <div class="infos info-berat">
                <div class="row">
                  <div class="col-7 text-right">
                    <div class="ml-auto">Total Berat : <span
                        class="">{{ number_format($order->total_weight, 0, ',', '.') }}</span> gram</div>
                  </div>
                  <div class="col-5">
                  </div>
                </div>
