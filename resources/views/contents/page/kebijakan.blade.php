        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <ol>
                  ...
                  <li>
                    Penngelola situs tidak bertanggung jawab terhadap penggunaan profil yang tidak menjadi miliknya atau penyalahgunaan profil
                  </li>

                  <li>
                    Pengelola situs berhak untuk melakukan blacklist terhadap akun profil yang disalahgunakan
                  </li>

                  <li>
                    Pengelola situs berhak untuk mengubah aturan dan ketentuan yang telah dibuat sebelumnya.
                  </li>
                </ol>
            </div>
            <div class="col-md-2"></div>
