	...
	<div class="new-activity-wrapper">
		...
		<div class="new-activity-text">
			...
			<a href="{{ route('user.getShow', $blog['user']['username']) }}" class="medium-title-lite ellipsis-title">
				...
				<div style="margin-left: 5px;background: #30b042;display:inline-block;width: 16px;height: 16px;border-radius: 50px;text-align: center;"><i class="fa fa-check" style="color: white;font-size: 10px;"></i></div>
				@endif
			</a>
