...
@section('content')
  <div class="container-mobile" style="padding: 20px;margin-bottom:100px;">
    ...
    {!! Form::open() !!}
      ...
      <div class="form-group">
        <label>Title</label>
        {!! Form::text('title',$update['title'],['class'=>'form-control','Title','required','id'=>'title']) !!}
      </div>

      <div class="form-group">
        <label>Description</label>
        {!! Form::textarea('description',$update['description'],['class'=>'summernote','id'=>'description']) !!}
      </div>
