...
@section('title', 'RTL - Belum Dibayar')
...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">Belum Dibayar</div>
  </div>
</div>

<div class="section-body">
  <h2 class="section-title">Belum Dibayar</h2>
  ...
  <div class="row">
    <div class="col-12 col-md-12 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="form-filter" action="{{ route('admin.reports.unpaid-order') }}">
            <div class="row">
              <div class="col-md-3">
          ...
          @if (isset($items))
          <a target="_blank" href="{{ route('admin.reports.unpaid-order.print') }}" class="btn btn-primary">Print</a>
          <br><br>
