...
@section('title', 'RTL - Penjualan Offline Toko')

@section('content')
<div class="section-header">
  <h1>Penjualan Offline Toko</h1>
  <div class="section-header-breadcrumb">
    <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></div>
    <div class="breadcrumb-item">Penjualan Offline Toko</div>
  </div>
</div>

<div class="section-body">
  <h2 class="section-title">Penjualan Offline Toko</h2>
  <p class="section-lead">
    Daftar penjualan offline toko
  </p>
    ...
    <div class="col-12 col-md-12 col-lg-12">
      <div class="card">
        <div class="card-header">
          <h4>Penjualan Offline Toko</h4>
        </div>
        <div class="card-body">
          <form id="form-filter" action="{{ route('admin.reports.store-offline-sales') }}">
            <div class="row">
              <div class="col-md-3">
          ...
          @if (isset($items))
          <a target="_blank" href="{{ route('admin.reports.store-offline-sales.print') }}" class="btn btn-primary">Print</a>
          <br><br>
