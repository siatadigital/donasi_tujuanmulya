...
@section('title', 'RTL - Tambah Hadiah')
...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">Tambah Hadiah</div>
  </div>
</div>

<div class="section-body">
  <h2 class="section-title">Tambah Hadiah</h2>
  <p class="section-lead">
    Form untuk tambah hadiah
  </p>
