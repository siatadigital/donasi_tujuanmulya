...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item active"><a href="{{ route('admin.offline-sales.index') }}">Penjualan</a></div>
...
<div class="section-body">
  ...
  <form action="{{ route('admin.offline-sales.update', ['id' => $sales->id]) }}" method="POST">
    <div class="row">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
...
var updateItemsType = function() {
    ...
    items = items.map(item => {
        ...
        var isValidType = ['normal', 'reseller', 'wholesaler'].includes(item.type);
...
$itemWrapper.on('change', '.form-quantity', function() {
    ...
    items = items.map((item, index) => {
        var isTypeValid = ['normal', 'reseller', 'wholesaler'].includes(item.type);
